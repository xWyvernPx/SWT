...
describe("Testing function checkPrimeAndFindPos with Data Driven Testing", () => {
  ...
  */
  test.each(data)("Testing function checkPrimeAndFindPos with DDT type 1", // cú pháp chơi DDT với jest 
    (input, expected) => {  //callback function với param là mỗi bộ dữ liệu (input, expected) trong bộ data truyền vào ở trên
