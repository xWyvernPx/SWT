...
describe("Testing function checkPrimeAndGetPosition", () => { /* Describe sẽ đưa ra một cái scope để test và nó có tên, như là trong một "vùng" đó thì chỉ test một thứ thôi. Và ở trong cái callback function này là cái "vùng " đó . Thì describe sẽ tạo ra một vùng mà gọi là test suit ( bộ test) nó bao gồm nhiều test function bên trong */
  test("Test function checkPrimeAndGetPosition with valid param", () => { /* Test function thì cũng định nghĩa một "vùng" được đặt tên và chưa các test case 
  ...
  */
  test("Test function checkPrimeAndGetPosition with invalid param", () => {
    ...
    expect(function () { return checkPrimeAndGetPosition(true) }).toThrow();
  });
});
